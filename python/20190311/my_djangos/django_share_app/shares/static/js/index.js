...
$('.search-text-icon').click(function() {
    ...
    if( !$("#files-info").val() || $("#files-info").val().length < 1 ) {
	...
	function addSearchFile(data) {
		...
		'<div class="file-content">' +
                    '<div class="file-name" style="width:25%;">'+data[i].file_name+'</div>' +
                    '<div class="file-size" style="width:10%;">'+data[i].file_size+'</div>' +
                    '<div class="file-date" style="width:10%;">'+data[i].ip_addr+'</div>' +
                    '<div class="file-date" style="width:20%;">'+data[i].upload_time+'</div>' +
                    '<div class="file-link" style="width:35%; padding-right: 80px; text-overflow: ellipsis; overflow: hidden;">' +
                        '<span>' +
                            'http://127.0.0.0:8000/'+data[i].file_path+
                        '</span>' +
                    '</div>' +
                    '<button><a href="/'+data[i].file_path+'">Download</a></button>' +
                '</div>'
